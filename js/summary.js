...
function greetingTime() {
  ...
  let greetingTimeResponsive = document.getElementById(
...
function loginTimeMessage() {
  let loginMessageDisplayed = JSON.parse(
    localStorage.getItem("loginMessageDisplayed")
  );

  if (loginMessageDisplayed) {
    let body = document.getElementById("summaryBody");
    let greetingResponsiveText = document.getElementById(
      "greeting-time-responsive"
    );
